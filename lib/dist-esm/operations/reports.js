...
class ReportsImpl {
     ...
     * @param options The options parameters.
     */
    generateTokenForCreateInGroup(groupId, requestBody, options) {
        return this.client.sendOperationRequest({ groupId, requestBody, options }, generateTokenForCreateInGroupOperationSpec);
    }
    /**
     * Rebinds the specified report to requested dataset id
     * @param groupId The group id
...
exports.ReportsImpl = ReportsImpl;
